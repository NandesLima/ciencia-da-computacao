...
- [ ] Introdução à Ciência da Computação com Python I
  - [ ] ⚡ Rápido: Python em 2 Semanas (Crash Course)
- [ ] Fundamentos Matemáticos para Computação
  - [ ] ⚡ Rápido: Matemática Acelerada
- [ ] Ciência da Computação 50 (CC50)
- [ ] Leitura e Produção de Textos
- [ ] Circuitos Digitais
- [ ] Lógica Formal

### 🛠️ Módulo 2: Aprofundamento de Conceitos Introdutórios
...
### 🌐 Módulo 5: Aprofundamento Técnico
